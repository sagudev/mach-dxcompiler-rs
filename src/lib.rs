...
pub unsafe extern "system" fn DxcCreateInstance(rclsid: *const c_void, riid: *const c_void, ppv: *mut *mut c_void) -> c_long {
...
mod bindings {
    ...
    extern "system" {
        ...
        pub fn DxcCreateInstance(rclsid: *const c_void, riid: *const c_void, ppv: *mut *mut c_void) -> c_long;
